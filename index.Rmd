...
**Today's visitor count** The number of people currently listed as "confirmed" for today's date are: **`r sum(tmp$Adults) + sum(tmp$Children)`** - (`r sum(tmp$Adults)` adults and `r sum(tmp$Children)`.
